                    ...
                    <div class="page-quick-sidebar">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active page-quick-sidebar-chat" id="quick_sidebar_tab_1">
                                <div class="page-quick-sidebar-list" style="position: relative; overflow: hidden; width: auto; height: 684px;"><div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list" data-height="684" data-initialized="1" style="overflow: hidden; width: auto; height: 684px;">
                                ...
                                </div><div class="slimScrollBar" style="background: rgb(187, 187, 187); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 535.304px;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(221, 221, 221); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
                                <div class="page-quick-sidebar-item">
                                    <div class="page-quick-sidebar-chat-user">
                                        ...
                                        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 579px;"><div class="page-quick-sidebar-chat-user-messages" data-height="579" data-initialized="1" style="overflow: hidden; width: auto; height: 579px;">
                                            <div class="post out">
                                        ...
                                        </div><div class="slimScrollBar" style="background: rgb(187, 187, 187); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 489.403px;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(234, 234, 234); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
                            ...
                            <div class="tab-pane page-quick-sidebar-alerts" id="quick_sidebar_tab_2">
                                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 679px;"><div class="page-quick-sidebar-alerts-list" data-height="679" data-initialized="1" style="overflow: hidden; width: auto; height: 679px;">
                            ...
                            <div class="tab-pane page-quick-sidebar-settings" id="quick_sidebar_tab_3">
                                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 679px;"><div class="page-quick-sidebar-settings-list" data-height="679" data-initialized="1" style="overflow: hidden; width: auto; height: 679px;">
